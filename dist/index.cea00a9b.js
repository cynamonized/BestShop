document.addEventListener("DOMContentLoaded", function() {
    ...
    function InputFields() {
        ...
        this.forms = {
            productsQuantity: this.formParent.querySelector(".input__number--products-quantity"),
            estimatedMonths: this.formParent.querySelector(".input__number--estimated-months"),
    ...
    function ResultObjects() {
        ...
        this.parentElement = document.querySelector(".calculator__columns .columns__right-column");
        // All output rows
        this.rows = {
    ...
    grabList.ListElements.forEach(function(listElement) {
        listElement.addEventListener("click", function() {
            ...
            if (listElementValue == "Professional" && inputFieldsObj.forms.packageLabel.innerText != "Professional") priceCalculator.AddToTotal(priceCalculator.prices.packageProfessional);
            if (listElementValue == "Premium" && inputFieldsObj.forms.packageLabel.innerText != "Premium") priceCalculator.AddToTotal(priceCalculator.prices.packagePremium);
            ///////////////////////
            ...
            // TO 0???????
            if (listElementValue != "Professional" && inputFieldsObj.forms.packageLabel.innerText == "Professional") priceCalculator.SubFromTotal(priceCalculator.prices.packageProfessional);
            if (listElementValue != "Premium" && inputFieldsObj.forms.packageLabel.innerText == "Premium") priceCalculator.SubFromTotal(priceCalculator.prices.packagePremium);
            ////////////////////////
            ...
            resultObjectsObj.rows.packageValueLabel.innerText = priceCalculator.prices.packagePremium;
